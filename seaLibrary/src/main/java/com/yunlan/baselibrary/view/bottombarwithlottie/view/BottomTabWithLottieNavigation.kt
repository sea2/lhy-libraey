...
import com.yunlan.baselibrary.R
import com.yunlan.baselibrary.view.bottombarwithlottie.OnTabClickListener
 ...
 */
public class BottomTabWithLottieNavigation @JvmOverloads constructor(
    context: Context,
    ...
    private fun addTab(i: Int, tabView: View) {
        ...
        with(ivTabIcon) {
            if (i == 2) {
//              setImageResource(R.drawable.ic_add_tab)
            } else {
        ...
        tabView.setOnClickListener(object : OnTabClickListener() {
    ...
    private fun updateTabStyles() {
        for (i in 0 until mTabCount) {
            ...
            with(ivTabIcon) {
                ...
                var lp = LinearLayoutCompat.LayoutParams(
...
//                        if (mIconWidth <= 0) LinearLayout.LayoutParams.WRAP_CONTENT else mIconWidth.toInt()-50,
//                        if (mIconHeight <= 0) LinearLayout.LayoutParams.WRAP_CONTENT else mIconHeight.toInt()-50
//                    )
//                }
    ...
    override fun onRestoreInstanceState(state: Parcelable?) {
        ...
        if (stateRestore is Bundle) {
            ...
            if (mCurrentTab != 0 && mTabsContainer.childCount > 0&&mCurrentTab!=2) {
